...
public class CircleImageView extends ImageView {
    ...
    public void setGradiente(){
        int[] colorList = {R.color.colorAccent, R.color.colorAccent};
        Shader shader = new SweepGradient(mStrokeBounds.width(), mStrokeBounds.height(), colorList, null);
