...
public class AvatarImageView extends CircleImageView {
    ...
    @NonNull
    private String extractInitials(@Nullable String letter) {
        if (letter == null) {
            return "";
        }
        String[] splitedName = letter.split(" ");

        if (splitedName.length > 1) {
            return String.valueOf(splitedName[0].charAt(0)) + String.valueOf(splitedName[1].charAt(0));
        } else {
            return String.valueOf(splitedName[0].charAt(0));
        }
    }
