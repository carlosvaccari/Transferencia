...
public abstract class NumberMask {

    public static final String FORMAT_FONE_11 = "(##) #####-####";
    ...
    public static TextWatcher mask(final EditText ediTxt, final String mask) {
        return new TextWatcher() {
            ...
            public void onTextChanged(final CharSequence s, final int start, final int before, final int count) {
                final String str = NumberMask.unmask(s.toString());
                String mascara = "";
                if (isUpdating) {
                    old = str;
                    isUpdating = false;
    ...
    public static String addMask(final String textoAFormatar){
        String unmasked = unmaskPhone(textoAFormatar);
        String mask  = FORMAT_FONE_11;
    ...
    public static String unmaskPhone(final String s) {
        return s.replaceAll("[.]", "")
                .replaceAll("[-]", "")
                .replaceAll("[/]", "")
                .replaceAll("[(]", "")
